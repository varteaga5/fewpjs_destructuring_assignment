...
const farmAnimalsNoHorse = 'cow sheep pig chicken';
const farmAnimals3 = 'cow sheep pig';


const colors = ['red', 'orange', 'yellow', 'green', 'blue', 'indigo', 'violet'];
const colorsMinus1 = ['red', 'orange', 'yellow', 'green', 'blue', 'violet'];
const indigoo = ['indigo']
...
const [bessie, dolly, babe, little] = farmAnimalsNoHorse.split(' ');
...
const [r, o, y, g, b, v] = colorsMinus1;
